...
private:
    /// value for showing mouse history
    bool mShowHistory = false;

    /// value for pruning all gardens
    bool mPrune = false;
...
public:
    ...
    afx_msg void OnUpdateViewMousehistory32803(CCmdUI* pCmdUI);
    afx_msg void OnViewMousehistory32803();
