...
BEGIN_MESSAGE_MAP(CChildView, CWnd)
    ...
    ON_WM_LBUTTONDBLCLK()
    ON_UPDATE_COMMAND_UI(ID_VIEW_MOUSEHISTORY32803, &CChildView::OnUpdateViewMousehistory32803)
    ON_COMMAND(ID_VIEW_MOUSEHISTORY32803, &CChildView::OnViewMousehistory32803)
...
/**
 * Handler for show mouse history
 */
void CChildView::OnViewMousehistory32803()
{
...
/**
 * Handler for mouse history checkbox
 * \param pCmdUI UI to update
 */
void CChildView::OnUpdateViewMousehistory32803(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(true);
...
/**
 * Menu handler for adding garden
 */
...
/**
 * Handler for prune menu check box
 * \param pCmdUI UI to update
 */
void CChildView::OnUpdateGardenPrune(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(true);  		// Will disable the menu option
    pCmdUI->SetCheck(mPrune);	// Will check the menu option
}


/**
 * Menu handler for pruning selected garden
 */
...
/**
 * Menu handler for pruning all gardens
 */
